...
orig1 = Hadamard(imread(MASKIMAGE,'jpg')); %[Normalized Original]
orig2 = Hadamard(imread('peach.jpg','jpg'));
orig3 = Hadamard(imread('melon.jpg','jpg'));
orig4 = Hadamard(imread('grape.jpg','jpg'));
orig5 = Hadamard(imread('kiwi.jpg','jpg'));
orig6 = Hadamard(imread('sw.jpg','jpg'));
% Test image Hadamard Transform
testspec = Hadamard(imread(TESTIMAGE,'jpg'));
